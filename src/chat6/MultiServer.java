...
public class MultiServer {
	...
	//생성자
	public MultiServer() {
		//클라이언트의 이름과 출력스트림을 저장 할 HashMap 생성
	...
	public void init() {
		...
		try {
			...
			while(true) {
				...
				/*
				클라이언트의 메세지를 모든 클라이턴트에게 전달하기 위한
				쓰레드 생성 및 start...
				*/
	...
	class MultiServerT extends Thread{
		...
		public void run() {
			...
			try {
				...
				//HashMap에 저장된 객체의 수로 접속자 수를 파악 할 수 있다.
				...
				/*
				클라이언트가 접속을 종료하면 예외가 발생되게 되어 finally로
